...
O que a base é (confirmado jun/2026 na <host-do-banco>): um dump das **tabelas do
...
Uso (na <host-do-banco>, que enxerga o lake — ou via túnel SSH com --ssh-host):
...
(host/porta/authSource + credencial <usuario-lake>) são derivados no script.
