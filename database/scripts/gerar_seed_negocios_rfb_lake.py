...
CALIBRAÇÃO (1ª vez — na <host-do-banco>):
  ...
  (OPP_MONGO_USER/PASS) ou de --opp-user/--opp-pass.
    ...
    python3 ..._negocios_rfb_lake.py --inspect --ano 2025 --mongo-host <host-do-lake>

    # EMPRESAS (porte) + SIMPLES (MEI)
    python3 ..._negocios_rfb_lake.py --inspect-rfb --ano 2025 --mongo-host <host-do-lake>

RODAR (uma rodada) + ESCREVER no OPP:

    python3 ..._negocios_rfb_lake.py --ano 2025 --mongo-host <host-do-lake> \
